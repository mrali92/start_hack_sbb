...
#
#
# bern_station = pd.read_csv(join(dirname(__file__), 'data', 'bern_park.csv')).dropna()
# # Create each of the tabs
# tab1 = histogram_tab(bern_station)
# tab2 = density_tab(bern_station)
# tab3 = table_tab(bern_station)
