...
def histogram_tab(bern_station):
	...
	def make_dataset(carrier_list, range_start = -60, range_end = 120, bin_width = 5):
		...
		for i, carrier_name in enumerate(carrier_list):
			...
			subset = bern_station[bern_station['name'] == carrier_name]
	...
	def make_plot(src):
		...
		p = figure(plot_width = 700, plot_height = 700, 
				  title = 'Histogram of Parking Space at Bern Bümpliz Süd Station',
				  x_axis_label = 'Date ()', y_axis_label = 'Occupancy')
	...
	# Carriers and colors
	available_carriers = list(set(bern_station['date_only']))
