...
def histogram_tab(flights):
	...
	def make_plot(src):
		...
		p = figure(plot_width = 700, plot_height = 700, 
				  title = 'Histogram of parked cars over day ',
				  x_axis_label = 'Datetime ', y_axis_label = 'number of parked cars ')

		# Quad glyphs to create a histogram
		p.quad(source = src, bottom = 0, top = 'number of parked cars', left = 'left', right = 'right',
		...
		hover = HoverTool(tooltips=[('Carrier', '@name'), 
									('Datetime', '@f_interval'),
									('number of parked cars', '@f_proportion')],
						  mode='vline')
